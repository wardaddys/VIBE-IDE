...
export function ModelSelector({ onClose }: Props) {
    ...
    const ofoxMappedModels = apiKeys.ofox
        ? (ofoxModels.length > 0
            ...
            : [
                { id: 'ofox:anthropic/claude-fable-5', name: 'Claude Fable 5 (OfoxAI)', provider: 'ofox' },
                { id: 'ofox:moonshotai/kimi-k3', name: 'Kimi K3 (OfoxAI)', provider: 'ofox' },
                { id: 'ofox:moonshotai/kimi-k2.7-code', name: 'Kimi K2.7 Code (OfoxAI)', provider: 'ofox' },
                { id: 'ofox:moonshotai/kimi-k2.6', name: 'Kimi K2.6 (OfoxAI)', provider: 'ofox' },
                { id: 'ofox:moonshotai/kimi-k2.5', name: 'Kimi K2.5 (OfoxAI)', provider: 'ofox' },
                { id: 'ofox:z-ai/glm-5', name: 'GLM-5 (OfoxAI)', provider: 'ofox' },
                { id: 'ofox:openai/gpt-5.1', name: 'GPT-5.1 (OfoxAI)', provider: 'ofox' },
                { id: 'ofox:anthropic/claude-sonnet-4.5', name: 'Claude Sonnet 4.5 (OfoxAI)', provider: 'ofox' },
                { id: 'ofox:google/gemini-3.5-flash', name: 'Gemini 3.5 Flash (OfoxAI)', provider: 'ofox' },
                { id: 'ofox:deepseek/deepseek-chat', name: 'DeepSeek V3 (OfoxAI)', provider: 'ofox' }
            ])
        : [];
